  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.customerManagementCustomer.home.createOrEditLabel" data-cy="CustomerCreateUpdateHeading">
            <Translate contentKey="gatewayApp.customerManagementCustomer.home.createOrEditLabel">Create or edit a Customer</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gatewayApp.customerManagementCustomer.name')}
                id="customer-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.customerManagementCustomer.address')}
                id="customer-address"
                name="address"
                data-cy="address"
                type="text"

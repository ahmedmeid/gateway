...
export const CustomerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.customerManagementCustomer.delete.question">
        <Translate contentKey="gatewayApp.customerManagementCustomer.delete.question" interpolate={{ id: customerEntity.id }}>
